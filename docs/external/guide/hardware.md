...
The [internal BOM](https://github.com/code-hartle-tech/medusa/blob/develop/wiki/hardware/bom.md) has the per-part details. Summary:
...
The public repository also contains reviewer-safe draft notes for the
[BOM, power budget, and form factor](https://github.com/code-hartle-tech/medusa/tree/develop/wiki/hardware).
Procurement records, operator-specific suppliers, and private prototype notes
belong in the separate tailnet-only HARTLE.TECH wiki.
